...
describe('AdminDashboard', () => {
  ...
  it('renders authenticated server management as a compact list, not detailed cards', () => {
    ...
    expect(html).not.toContain('服务器排序')
    expect(html).toContain('admin-inline-sort-list')
    expect(html).toContain('admin-inline-sort-row')
    expect(html).toContain('aria-label="拖动 服务器 Example Node A 调整顺序"')
  ...
  it('keeps latency monitor management on its own list page', () => {
    ...
    expect(html).toContain('admin-inline-sort-list')
    expect(html).toContain('admin-inline-sort-row')
    expect(html).toContain('aria-label="拖动 延迟监控 Example Node A 调整顺序"')
