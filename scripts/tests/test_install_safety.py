...
class InstallSafetyTest(unittest.TestCase):
    ...
    def test_release_workflow_publishes_github_signed_image_attestation(self):
        ...
        self.assertIn("go-version: '1.26.4'", ci_workflow)
        ...
        self.assertIn('golang:1.26.4-bookworm@sha256:b305420a68d0f229d91eb3b3ed9e519fcf2cf5461da4bef997bf927e8c0bfd2b', dockerfile)
